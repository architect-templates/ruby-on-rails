...
---
# Using Ruby-on-Rails with Architect
Ruby-on-Rails is a full-stack framework to build both front and backends of web applications.
In this example, you'll learn how to capture an app written with [Ruby-on-Rails](https://rubyonrails.org/).
