...
---
# Using Ruby-on-Rails on Architect
...
In this example, you'll learn how to capture an app written with [Ruby-on-Rails](https://rubyonrails.org/) and a [Postgres](https://www.postgresql.org/)
...
$ git clone https://github.com/architect-templates/ruby-on-rails.git
$ cd ./ruby-on-rails
